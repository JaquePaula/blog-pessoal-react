...
function NavBar() {
  ...
  function logout() {
    handleLogout();
    toastAlerta("Deslogado com sucesso", "sucesso");
    navigate("/login");
  }
  let navbarComponent;
    ...
    navbarComponent = (
      <div className="w-full  bg-amber-50 text-gray-700 flex justify-center py-4">
        <div className="container flex justify-between text-lg">
          <Link
            to="home"
            className="text-2xl font-bold uppercase text-amber-700"
          >
            Blog Pessoal Pet{" "}
          </Link>

          <div className="flex gap-4">
            <Link to="/postagens" className=" text-amber-700 hover:underline  ">
              Postagens
            </Link>

            <Link to="/temas" className="text-amber-700 hover:underline ">
              Temas
            </Link>
